...
class ArticleService
{
    public static function getNavCates()
    {
        return Cache::remember(
            config('define.cache.home_nav_cates.key'),
            config('define.cache.home_nav_cates.minutes'),
            function () {
    ...
    {
        return Cache::remember(
            config('define.cache.home_sider_cates.key'),
            config('define.cache.home_sider_cates.minutes'),
            function () {
    ...
    {
        return Cache::remember(
            config('define.cache.home_sider_archives.key'),
            config('define.cache.home_sider_archives.minutes'),
            function () {
    ...
    {
        return Cache::remember(
            config('define.cache.home_sider_tags.key'),
            config('define.cache.home_sider_tags.minutes'),
            function () {
    ...
    {
        return Cache::remember(
            config('define.cache.home_footer_blogrolls.key'),
            config('define.cache.home_footer_blogrolls.minutes'),
            function () {
